...
//  COMPLETED (10) Add constant values to sync Sunshine every 3 - 4 hours
    private static final int DB_SYNC_FREQUENCY_HOUR = 4;
    private static final int DB_SYNC_FREQUENCY_SECS = (int) TimeUnit.HOURS.toSeconds(DB_SYNC_FREQUENCY_HOUR);
    private static final int SYNC_FLEXTIME_SECONDS = DB_SYNC_FREQUENCY_SECS / 3;

    private static boolean sInitialized;

//  COMPLETED (11) Add a sync tag to identify our sync job
    private static final String DB_SYNC_JOB_TAG = "db_sync_tag";

//  COMPLETED (12) Create a method to schedule our periodic weather sync
    public static void scheduleWeatherDbSync(@NonNull final Context context) {
        ...
        Job contraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setTag(DB_SYNC_JOB_TAG)
                //.addConstraint(Constraint.DEVICE_CHARGING)
                .addConstraint(Constraint.ON_ANY_NETWORK)
                .setLifetime(Lifetime.FOREVER)
                .setRecurring(true)
                .setTrigger(Trigger.executionWindow(DB_SYNC_FREQUENCY_SECS, SYNC_FLEXTIME_SECONDS))
