            ...
            case CODE_WEATHER:
                ...
                try {
                    for (ContentValues value : values) {
                        // Validation
                        final long weatherDate = value.getAsLong(WeatherContract.WeatherEntry.COLUMN_DATE);
                        if (!SunshineDateUtils.isDateNormalized(weatherDate)) {
                            throw new IllegalArgumentException("Data must be normalized to insert, date: " + weatherDate);
                        }
                ...
                break;
            default:
                // COMPLETED (4) If the URI does NOT match CODE_WEATHER, return the super implementation of bulkInsert
