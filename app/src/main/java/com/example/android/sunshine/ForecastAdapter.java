...
//      COMPLETED (7) Replace the single TextView with Views to display all of the weather info
        ...
        forecastAdapterViewHolder.mForecastListItemBinding.tvForecastDate.setText(dateString);
        forecastAdapterViewHolder.mForecastListItemBinding.tvForecastTitle.setText(description);
        forecastAdapterViewHolder.mForecastListItemBinding.tvForecastHighTemp.setText(SunshineWeatherUtils.formatTemperature(mContext, highInCelsius));
        forecastAdapterViewHolder.mForecastListItemBinding.tvForecastLowTemp.setText(SunshineWeatherUtils.formatTemperature(mContext, lowInCelsius));
    }
...
//      COMPLETED (5) Add an ImageView for the weather icon
        final ForecastListItemBinding mForecastListItemBinding;

        ForecastAdapterViewHolder(View view) {
            super(view);

//          COMPLETED (6) Get references to all new views and delete this line
            mForecastListItemBinding = DataBindingUtil.bind(view);
